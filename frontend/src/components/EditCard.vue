<template>
  <main class="form-signin w-50 m-auto">
    <form @submit.prevent="EditCard">
      ...
      <div class="form-floating mb-3">
        <textarea type="textarea" rows="10" v-model="content" class="form-control" id="floatingContent"
      ...
      <div class="form-floating mb-3">
        <input type="date" v-model="deadline" class="form-control" id="floatingDeadline"
      ...
      <div class="form-floating mb-3">
        <select name="move-list" id="move-list" v-model="list_id" class="form-control">
    ...
    <div class="text-center fw-bold">
      Don't want to edit card?<router-link class="link-primary" to="/">Back to Home</router-link>
    </div>
  </main>
</template>
...
export default {
  ...
  methods: {
    EditCard: function () {
      ...
      if (this.$v.$error) {
        ...
        fetch(`http://127.0.0.1:5000/api/card/${this.$route.params.id}`, {
          method: "PUT",
          headers: {
  ...
  mounted: function () {
    fetch(`http://127.0.0.1:5000/api/editcard/${this.$route.params.id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Access-Control-Allow-Origin": "*",
