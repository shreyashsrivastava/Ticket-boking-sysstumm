<template>
  <div class="main">
    <div class="container" id="reportPage">
      ...
      <div class="row m-3">
        <div id="chartContainer" class="justify-content-center m-auto" style="width: 50rem">
          <!-- <canvas id="myChart"></canvas> -->
          <img alt="Bar chart" :src="'data:image/png;base64,' + img64" />"
        </div>
      </div>
      <div class="row m-3">
        <a @click="downloadPdf" class="nav-links" id="downloadPdf">Download Report Page as PDF</a>
      </div>
      <br />
